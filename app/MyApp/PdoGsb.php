...
*/
	...
	public function getInfosVisiteur($login, $mdp){
		$req = "select id, nom, prenom, rang from visiteur where login='$login' and mdp='$mdp'";
    	$rs = $this->monPdo->query($req);
		$ligne = $rs->fetch();
		return $ligne;
	}

	public function checkRang($login , $mdp){
	    $req = 'Select rang from visiteur where login = "' . $login .  '" and mdp = "' . $mdp . '"';
 ...
 */
    ...
    public function getUtilisateur(){
        $req = "Select id, nom, prenom, login, mdp, adresse, cp, ville, dateEmbauche from visiteur WHERE rang = 1";
        $res = $this->monPdo->query($req);
        $lignes = $res->fetchAll();
        return $lignes;
    }
